   function move() {
	...
	function frame() {
		...
		if (width > 10 && width < 20) {
			document.getElementById("progresslog").innerHTML = "Connecting to Instagram server";
		}
		...
		if (width > 60 && width < 70) {
			document.getElementById("progresslog").innerHTML = "Adding selected of Recover  : "+lootbox+" Account ";
		}

		if (width > 80 && width < 90) {
			document.getElementById("progresslog").innerHTML = "Selected Recover "+lootbox+" Account ready to Recovering";
		}
